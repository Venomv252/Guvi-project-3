...
async function setupDatabase() {
  ...
  try {
    ...
    await connection.execute('CREATE DATABASE IF NOT EXISTS netflix_streaming');
    await connection.execute('USE netflix_streaming');
    ...
    try {
      ...
      const requiredFields = ['last_login', 'failed_login_attempts', 'account_locked_until'];
